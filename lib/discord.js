  ...
  const embeds = [
    {
      ...
      title: `[${source.badge}] ${title}`,
      url: safeMangaUrl || undefined,
      description: [
        `**${chapter}**`,
        `\`${status}\` | \`${updated}\` | ${ratingStars(rating)}`,
        "",
        `[Read Chapter](${safeChapterUrl}) | [Series Page](${safeMangaUrl || safeChapterUrl})`,
      ].join("\n"),
      fields: [
        {
          name: "Source",
      ...
      footer: {
        text: `Manga Tracker | ${source.badge} | ${chapter}`,
        icon_url:
          "https://02.ikiru.wtf/wp-content/uploads/2025/06/logo-ikiru-264736-Qt7APF3i.png",
      },
