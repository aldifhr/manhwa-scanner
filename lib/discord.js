...
// token bisa string langsung atau payload object
...
// satu fungsi untuk semua edit dengan components
...
export async function sendDiscordEmbed(data, channelId) {
  console.log("🖼️ Cover URL:", data.cover); 
  const description =
  ...
  const embeds = [
    {
      ...
      description: [
        ...
        .filter(Boolean)
        .join("\n"),
      // ✅ image harus di embed yang sama dengan title/description
