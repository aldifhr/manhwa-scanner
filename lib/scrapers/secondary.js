...
// Ultra fast mode: sub-10s target
const FASTCRON_SAFE_CONFIG = {
  REQUEST_TIMEOUT: 3000, // Ultra fast 3s timeout
  MAX_RETRIES: 0, // No retries - immediate fail
  RETRY_DELAY: 0, // No delay
  BATCH_SIZE: 12, // Max parallel
  TOTAL_TIMEOUT: 8000, // Hard 8s limit
  MAX_CHAPTERS_PER_RUN: 3, // Only most critical
};
