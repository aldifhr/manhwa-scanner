...
function getFallbackChapters(row, shouldUseDetail) {
  // Always try to get chapters from row data, regardless of shouldUseDetail
  // shouldUseDetail=false means detail fetch failed, but we should still use fallback
