...
function extractDetailChaptersFromMangaDetail(payload, now = Date.now(), lookbackHours = FRESH_CHAPTER_HOURS_DEFAULT) {
...
async function fetchSecondaryRecentChaptersFromMangaDetail(apiBase, mangaId, lookbackHours = FRESH_CHAPTER_HOURS_DEFAULT) {
