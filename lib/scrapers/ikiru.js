...
const FASTCRON_SAFE_CONFIG = {
  ...
  BATCH_SIZE: 6, // Balanced parallel processing
  TOTAL_TIMEOUT: 35000, // Increased to allow more thorough scraping (+20s)
  MAX_CHAPTERS_PER_RUN: 25, // Increased from 15 (scrape more chapters)
};
