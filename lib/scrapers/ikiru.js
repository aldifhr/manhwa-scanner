...
// Fast mode: aggressive optimization for sub-5s scraping
const FASTCRON_SAFE_CONFIG = {
  REQUEST_TIMEOUT: 2500, // Ultra fast 2.5s timeout (fail super fast)
  MAX_RETRIES: 0, // No retries - immediate fail for speed
  RETRY_DELAY: 0, // No delay between retries
  BATCH_SIZE: 12, // Maximum parallelism
  TOTAL_TIMEOUT: 8000, // 8s hard limit (guarantees sub-10s total)
  MAX_CHAPTERS_PER_RUN: 3, // Only most recent 3 chapters
};
