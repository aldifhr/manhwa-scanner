...
import { IKIRU_CONFIG, SCRAPER_LOOKBACK_HOURS, FASTCRON_SAFE_CONFIG } from "../config.js";

const logger = getLogger({ scope: "ikiru" });

// Timeout and freshness helpers
...
export function collectIkiruRecentChaptersFromAjaxHtml(
  ...
  $(AJAX_CHAPTER_SELECTORS).each((_, el) => {
    ...
    if (Date.now() - parsedUpdated.getTime() > 24 * 3600000) {
