...
export async function orchestrateScrapeSources({
  ...
  try {
    ...
    // Sort by timestamp (ascending) + chapter number (ascending) for perfect stability
    deduped.sort((a, b) => {
      ...
      // Secondary sort oleh nomor chapter jika timestamp sama (untuk kestabilan urutan)
