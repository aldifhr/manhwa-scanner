...
import { dispatchChapters, prepareDispatchQueue } from "../services/dispatch.js";
...
function sortMatchedChapters(items = []) {
...
async function handleQuickSync(payload, options) {
  try {
