  ...
  if (subcommand === "ping") {
    ...
    if (!newMode) {
      ...
      if (currentMode === NOTIFY_MODES.ALL) {
        ...
        desc =
          "⭐ **Hanya Follow**: Kamu hanya akan di-tag untuk manga yang kamu klik 'Follow'.";
      } else {
    ...
    try {
      ...
      if (newMode === NOTIFY_MODES.ALL) {
        msg =
          "✅ Mode Berhasil diubah: **SEMUA UPDATE**. Sekarang kamu akan di-tag untuk setiap update manga!";
      } else if (newMode === NOTIFY_MODES.FOLLOWS) {
        msg =
          "✅ Mode Berhasil diubah: **HANYA FOLLOW**. Kamu hanya akan di-tag untuk manga yang kamu ikuti secara manual.";
      } else {
        msg =
          "✅ Mode Berhasil diubah: **NONAKTIF**. Kamu tidak akan mendapatkan tag notifikasi lagi.";
      }
