...
import { MARK_REASON_LABELS } from "../domain/whitelist.js";
import { markWhitelistEntry } from "../services/whitelist.js";
...
export default function handleMark(payload, options, res) {
  ...
  if (!query || !reason) {
    return res.json({
      ...
      data: { content: "Silakan masukkan judul/nomor manga dan alasan mark.", flags: 64 },
    });
  }
