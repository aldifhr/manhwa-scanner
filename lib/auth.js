...
function getSessionSecret() {
  ...
  console.log(
    "[DEBUG] getSessionSecret - DASHBOARD_SESSION_SECRET exists:",
    !!process.env.DASHBOARD_SESSION_SECRET,
  );
  console.log(
    "[DEBUG] getSessionSecret - CRON_SECRET exists:",
    !!process.env.CRON_SECRET,
  );
  console.log("[DEBUG] getSessionSecret - final secret exists:", !!secret);
  return secret;
}
