...
export const IKIRU_CONFIG = {
  ...
  MAX_CHAPTERS_PER_RUN: resolvePositiveInt(process.env.IKIRU_MAX_CHAPTERS, 5),
};
...
export const SECONDARY_CONFIG = {
  ...
  BATCH_SIZE: 10,
  TOTAL_TIMEOUT: 17500,
  MAX_CHAPTERS_PER_RUN: 8,
  DIRECT_FALLBACK_MAX_URLS: resolvePositiveInt(process.env.SECONDARY_DIRECT_FALLBACK_MAX_URLS, 50),
};
