...
export const IKIRU_CONFIG = {
  REQUEST_TIMEOUT: resolvePositiveInt(process.env.IKIRU_REQUEST_TIMEOUT_MS, 8000),
  MAX_RETRIES: resolvePositiveInt(process.env.IKIRU_MAX_RETRIES, 1),
  RETRY_DELAY: 300,
  BATCH_SIZE: 15,
  TOTAL_TIMEOUT: resolvePositiveInt(process.env.IKIRU_TOTAL_TIMEOUT_MS, 12000),
...
export const SECONDARY_CONFIG = {
  REQUEST_TIMEOUT: resolvePositiveInt(process.env.SECONDARY_REQUEST_TIMEOUT_MS, 6000),
