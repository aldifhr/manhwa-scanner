...
export const IKIRU_CONFIG = {
  REQUEST_TIMEOUT: resolvePositiveInt(process.env.IKIRU_REQUEST_TIMEOUT_MS, 15000),
  MAX_RETRIES: resolvePositiveInt(process.env.IKIRU_MAX_RETRIES, 1),
  RETRY_DELAY: 300,
  BATCH_SIZE: 15,
  TOTAL_TIMEOUT: resolvePositiveInt(process.env.IKIRU_TOTAL_TIMEOUT_MS, 22000),
...
export const SECONDARY_CONFIG = {
  REQUEST_TIMEOUT: resolvePositiveInt(process.env.SECONDARY_REQUEST_TIMEOUT_MS, 10000),
  MAX_RETRIES: resolvePositiveInt(process.env.SECONDARY_MAX_RETRIES, 2),
  RETRY_DELAY: 500,
  BATCH_SIZE: 10,
  TOTAL_TIMEOUT: 20000,
