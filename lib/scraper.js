...
export async function scrapePopular() {
  ...
  // Find Popular Today section - look for h1/h2 with "Popular" text
  ...
  $("*").each((i, el) => {
    ...
    // Scrape swiper slides in Popular section
    if (inPopularSection) {
  ...
  // Alternative: directly find all swiper slides with manga data
  if (results.length === 0) {
