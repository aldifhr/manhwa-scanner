...
async function test() {
  const url =
    "https://e.shinigami.asia/series/the-rebel-of-the-tyrant-noble-family/";
  ...
  const desc = $(".summary__content, .manga-excerpt, .description, .synopsis")
    .first()
    .text()
    .trim();
  ...
  console.log(
    "Post ID (often manga_id):",
    postIdMatch ? postIdMatch[1] : "NOT FOUND",
  );
}
