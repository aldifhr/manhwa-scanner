...
export async function handleWhitelistDelete(request: Request): Promise<Response> {
  try {
    ...
    return catchError(err) as Response;
  }
}

export async function handleWhitelistPost(request: Request): Promise<Response> {
  try {
