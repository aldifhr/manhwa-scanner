...
<div class="max-w-4xl mx-auto px-4 py-6">
  <h1 class="text-xl font-bold capitalize">dispatch-history</h1>
  <p class="text-white/60 text-sm mt-2">Svelte page dispatch-history — parity stub (data from +page.ts).</p>
  {#if data}
