...
from app.api import dashboard as dashboard_api, catalog as catalog_api, auth as auth_api, dispatches as dispatches_api, observability as observability_api, system as system_api, rss as rss_api, health as health_api, error_logs as error_logs_api, analytics as analytics_api, audit_log as audit_log_api, confidence as confidence_api, cron_health as cron_health_api
...
def register_core(app):
    ...
    app.include_router(confidence_api.router, prefix="/api/v1")
