...
from app.api import public_stats as public_stats_api, audit as audit_api, recommended as recommended_api
...
def register_content(app):
    ...
    app.include_router(recommended_api.router, prefix="/api/v1")
